...
namespace _112NewsVideoMarked.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        {
			[Required]
			[StringLength(50, ErrorMessage = "Brugernavn skal være mellem 3 og 20 karakter langt!", MinimumLength = 3)]
            ...
            [Required]
            [StringLength(100, ErrorMessage = "{0} skal være {2} og max {1} karakter langt.", MinimumLength = 6)]
